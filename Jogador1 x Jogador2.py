...
def obter_movimento(jogador):
    while True:
        try:
            linha = int(input(f"Jogador {jogador}, entre com a linha (0, 1, 2): "))
            coluna = int(input(f"Jogador {jogador}, entre com a coluna (0, 1, 2): "))
...
def jogo_da_velha():
    ...
    while True:
        ...
        linha, coluna = obter_movimento(jogador_atual)
